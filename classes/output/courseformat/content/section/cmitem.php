...
/**
 * Output cmitem for the format_mootsample plugin.
 *
...
namespace format_mootsample\output\courseformat\content\section;
...
class cmitem extends cmitem_base {
    ...
    public function get_template_name(\renderer_base $renderer): string {
        return 'format_mootsample/local/content/section/cmitem';
    }
}
